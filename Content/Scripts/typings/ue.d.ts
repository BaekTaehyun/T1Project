...
declare type EFoundObjectType = 'None' | 'PersistentPoint' | 'Plane' | 'Generic' | 'EFoundObjectType_MAX';
declare var EFoundObjectType : { None:'None',PersistentPoint:'PersistentPoint',Plane:'Plane',Generic:'Generic',EFoundObjectType_MAX:'EFoundObjectType_MAX', };
declare class FoundObjectProperty { 
	Key: string;
	Value: string;
	clone() : FoundObjectProperty;
	static C(Other: UObject | any): FoundObjectProperty;
}

declare class FoundObjectComponent extends SceneComponent { 
	QueryObjectID: string;
	QueryLabels: string[];
	QueryTypes: EFoundObjectType[];
	QueryProperties: FoundObjectProperty[];
	MaxResults: number;
	SearchVolume: BoxComponent;
	static Load(ResourceName: string): FoundObjectComponent;
	static Find(Outer: UObject, ResourceName: string): FoundObjectComponent;
	static GetDefaultObject(): FoundObjectComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): FoundObjectComponent;
	static C(Other: UObject | any): FoundObjectComponent;
}
...
declare type EMeshType = 'Full' | 'Blocks' | 'PointCloud' | 'EMeshType_MAX';
declare var EMeshType : { Full:'Full',Blocks:'Blocks',PointCloud:'PointCloud',EMeshType_MAX:'EMeshType_MAX', };
...
declare class MagicLeapControllerFunctionLibrary extends BlueprintFunctionLibrary { 
	...
	static CalibrateControllerNow(Hand: EControllerHand,StartPosition: Vector,StartOrientation: Rotator): void;
...
declare type EStaticGestures = 'Finger' | 'Fist' | 'Pinch' | 'Thumb' | 'L' | 'OpenHandBack' | 'Ok' | 'C' | 'NoHand' | 'EStaticGestures_MAX';
declare var EStaticGestures : { Finger:'Finger',Fist:'Fist',Pinch:'Pinch',Thumb:'Thumb',L:'L',OpenHandBack:'OpenHandBack',Ok:'Ok',C:'C',NoHand:'NoHand',EStaticGestures_MAX:'EStaticGestures_MAX', };
declare type EGestureKeypointsFilterLevel = 'NoFilter' | 'SimpleSmoothing' | 'PredictiveSmoothing' | 'EGestureKeypointsFilterLevel_MAX';
declare var EGestureKeypointsFilterLevel : { NoFilter:'NoFilter',SimpleSmoothing:'SimpleSmoothing',PredictiveSmoothing:'PredictiveSmoothing',EGestureKeypointsFilterLevel_MAX:'EGestureKeypointsFilterLevel_MAX', };
declare type EGestureRecognitionFilterLevel = 'NoFilter' | 'SlightRobustnessToFlicker' | 'MoreRobustnessToFlicker' | 'EGestureRecognitionFilterLevel_MAX';
declare var EGestureRecognitionFilterLevel : { NoFilter:'NoFilter',SlightRobustnessToFlicker:'SlightRobustnessToFlicker',MoreRobustnessToFlicker:'MoreRobustnessToFlicker',EGestureRecognitionFilterLevel_MAX:'EGestureRecognitionFilterLevel_MAX', };
declare type EGestureTransformSpace = 'Tracking' | 'World' | 'Hand' | 'EGestureTransformSpace_MAX';
declare var EGestureTransformSpace : { Tracking:'Tracking',World:'World',Hand:'Hand',EGestureTransformSpace_MAX:'EGestureTransformSpace_MAX', };
declare class MagicLeapGesturesFunctionLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): MagicLeapGesturesFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): MagicLeapGesturesFunctionLibrary;
	static GetDefaultObject(): MagicLeapGesturesFunctionLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MagicLeapGesturesFunctionLibrary;
	static SetStaticGestureConfidenceThreshold(Gesture: EStaticGestures,Confidence: number): void;
	static SetConfiguration(StaticGesturesToActivate: EStaticGestures[],KeypointsFilterLevel: EGestureKeypointsFilterLevel,GestureFilterLevel: EGestureRecognitionFilterLevel,HandSwitchingFilterLevel: EGestureRecognitionFilterLevel): boolean;
	static GetStaticGestureConfidenceThreshold(Gesture: EStaticGestures): number;
	static GetHandSecondary(Hand: EControllerHand,TransformSpace: EGestureTransformSpace,Secondary?: Transform): {Secondary: Transform, $: boolean};
	static GetHandPointer(Hand: EControllerHand,TransformSpace: EGestureTransformSpace,Pointer?: Transform): {Pointer: Transform, $: boolean};
	static GetHandGestureConfidence(Hand: EControllerHand,Confidence?: number): {Confidence: number, $: boolean};
	...
	static GetCurrentGesture(Hand: EControllerHand,Gesture?: EStaticGestures): {Gesture: EStaticGestures, $: boolean};
	static GetConfiguration(ActiveStaticGestures?: EStaticGestures[],KeypointsFilterLevel?: EGestureKeypointsFilterLevel,GestureFilterLevel?: EGestureRecognitionFilterLevel,HandSwitchingFilterLevel?: EGestureRecognitionFilterLevel): {ActiveStaticGestures: EStaticGestures[], KeypointsFilterLevel: EGestureKeypointsFilterLevel, GestureFilterLevel: EGestureRecognitionFilterLevel, HandSwitchingFilterLevel: EGestureRecognitionFilterLevel, $: boolean};
	static C(Other: UObject | any): MagicLeapGesturesFunctionLibrary;
}
...
declare type EMagicLeapIdentityAttribute = 'UserID' | 'GivenName' | 'FamilyName' | 'Email' | 'Status' | 'TermsAccepted' | 'Birthday' | 'Company' | 'Industry' | 'Location' | 'Tagline' | 'PhoneNumber' | 'Avatar2D' | 'Avatar3D' | 'IsDeveloper' | 'Unknown' | 'EMagicLeapIdentityAttribute_MAX';
declare var EMagicLeapIdentityAttribute : { UserID:'UserID',GivenName:'GivenName',FamilyName:'FamilyName',Email:'Email',Status:'Status',TermsAccepted:'TermsAccepted',Birthday:'Birthday',Company:'Company',Industry:'Industry',Location:'Location',Tagline:'Tagline',PhoneNumber:'PhoneNumber',Avatar2D:'Avatar2D',Avatar3D:'Avatar3D',IsDeveloper:'IsDeveloper',Unknown:'Unknown',EMagicLeapIdentityAttribute_MAX:'EMagicLeapIdentityAttribute_MAX', };
declare class MagicLeapIdentityAttribute { 
	Attribute: EMagicLeapIdentityAttribute;
	Value: string;
	clone() : MagicLeapIdentityAttribute;
	static C(Other: UObject | any): MagicLeapIdentityAttribute;
}

declare type EMagicLeapIdentityError = 'Ok' | 'FailedToConnectToLocalService' | 'FailedToConnectToCloudService' | 'CloudAuthentication' | 'InvalidInformationFromCloud' | 'InvalidArgument' | 'AsyncOperationNotComplete' | 'OtherError' | 'EMagicLeapIdentityError_MAX';
declare var EMagicLeapIdentityError : { Ok:'Ok',FailedToConnectToLocalService:'FailedToConnectToLocalService',FailedToConnectToCloudService:'FailedToConnectToCloudService',CloudAuthentication:'CloudAuthentication',InvalidInformationFromCloud:'InvalidInformationFromCloud',InvalidArgument:'InvalidArgument',AsyncOperationNotComplete:'AsyncOperationNotComplete',OtherError:'OtherError',EMagicLeapIdentityError_MAX:'EMagicLeapIdentityError_MAX', };
declare class MagicLeapIdentity extends UObject { 
	...
	RequestAttributeValue(RequestedAttributeList: EMagicLeapIdentityAttribute[],RequestedAttributeValues?: MagicLeapIdentityAttribute[]): {RequestedAttributeValues: MagicLeapIdentityAttribute[], $: EMagicLeapIdentityError};
	ModifyAttributeValue(UpdatedAttributeValueList: MagicLeapIdentityAttribute[],AttributesUpdatedSuccessfully?: EMagicLeapIdentityAttribute[]): {AttributesUpdatedSuccessfully: EMagicLeapIdentityAttribute[], $: EMagicLeapIdentityError};
	GetAllAvailableAttributes(AvailableAttributes?: EMagicLeapIdentityAttribute[]): {AvailableAttributes: EMagicLeapIdentityAttribute[], $: EMagicLeapIdentityError};
	static C(Other: UObject | any): MagicLeapIdentity;
}

declare type EMagicLeapPrivilege = 'Invalid' | 'AddressBookRead' | 'AddressBookWrite' | 'AudioRecognizer' | 'AudioSettings' | 'BatteryInfo' | 'CalendarRead' | 'CalendarWrite' | 'CameraCapture' | 'DenseMap' | 'EmailSend' | 'Eyetrack' | 'Headpose' | 'InAppPurchase' | 'Location' | 'AudioCaptureMic' | 'DrmCertificates' | 'Occlusion' | 'ScreenCapture' | 'Internet' | 'AudioCaptureMixed' | 'IdentityRead' | 'IdentityModify' | 'BackgroundDownload' | 'BackgroundUpload' | 'MediaDrm' | 'Media' | 'MediaMetadata' | 'PowerInfo' | 'AudioCaptureVirtual' | 'CalibrationRigModelRead' | 'NetworkServer' | 'LocalAreaNetwork' | 'VoiceInput' | 'ConnectBackgroundMusicService' | 'RegisterBackgroundMusicService' | 'NormalNotificationsUsage' | 'MusicService' | 'BackgroundLowLatencyLightwear' | 'EMagicLeapPrivilege_MAX';
declare var EMagicLeapPrivilege : { Invalid:'Invalid',AddressBookRead:'AddressBookRead',AddressBookWrite:'AddressBookWrite',AudioRecognizer:'AudioRecognizer',AudioSettings:'AudioSettings',BatteryInfo:'BatteryInfo',CalendarRead:'CalendarRead',CalendarWrite:'CalendarWrite',CameraCapture:'CameraCapture',DenseMap:'DenseMap',EmailSend:'EmailSend',Eyetrack:'Eyetrack',Headpose:'Headpose',InAppPurchase:'InAppPurchase',Location:'Location',AudioCaptureMic:'AudioCaptureMic',DrmCertificates:'DrmCertificates',Occlusion:'Occlusion',ScreenCapture:'ScreenCapture',Internet:'Internet',AudioCaptureMixed:'AudioCaptureMixed',IdentityRead:'IdentityRead',IdentityModify:'IdentityModify',BackgroundDownload:'BackgroundDownload',BackgroundUpload:'BackgroundUpload',MediaDrm:'MediaDrm',Media:'Media',MediaMetadata:'MediaMetadata',PowerInfo:'PowerInfo',AudioCaptureVirtual:'AudioCaptureVirtual',CalibrationRigModelRead:'CalibrationRigModelRead',NetworkServer:'NetworkServer',LocalAreaNetwork:'LocalAreaNetwork',VoiceInput:'VoiceInput',ConnectBackgroundMusicService:'ConnectBackgroundMusicService',RegisterBackgroundMusicService:'RegisterBackgroundMusicService',NormalNotificationsUsage:'NormalNotificationsUsage',MusicService:'MusicService',BackgroundLowLatencyLightwear:'BackgroundLowLatencyLightwear',EMagicLeapPrivilege_MAX:'EMagicLeapPrivilege_MAX', };
declare class MagicLeapPrivileges extends UObject { 
...
declare class EmulatorCameraModifier extends CameraModifier { 
	CompositingMatInst: MaterialInstanceDynamic;
	static Load(ResourceName: string): EmulatorCameraModifier;
	static Find(Outer: UObject, ResourceName: string): EmulatorCameraModifier;
	static GetDefaultObject(): EmulatorCameraModifier;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EmulatorCameraModifier;
	static C(Other: UObject | any): EmulatorCameraModifier;
}

declare class MagicLeapEmulatorBackgroundMarker extends Info { 
	bParentLevelIsBackgroundLevel: boolean;
	static GetDefaultObject(): MagicLeapEmulatorBackgroundMarker;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MagicLeapEmulatorBackgroundMarker;
	static C(Other: UObject | any): MagicLeapEmulatorBackgroundMarker;
}

declare class MagicLeapEmulatorSceneCaptureComponent extends SceneCaptureComponent2D { 
	static Load(ResourceName: string): MagicLeapEmulatorSceneCaptureComponent;
	static Find(Outer: UObject, ResourceName: string): MagicLeapEmulatorSceneCaptureComponent;
	static GetDefaultObject(): MagicLeapEmulatorSceneCaptureComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MagicLeapEmulatorSceneCaptureComponent;
	static C(Other: UObject | any): MagicLeapEmulatorSceneCaptureComponent;
}

declare class MagicLeapEmulatorSettings extends UObject { 
	bEnableMagicLeapEmulation: boolean;
	bEnableCollisionWithBackground: boolean;
	bLimitForegroundFOV: boolean;
	ForegroundAspectRatio: number;
	ForegroundHorizontalFOV: number;
	EmulatorCompositingMaterial: SoftObjectPath;
	static Load(ResourceName: string): MagicLeapEmulatorSettings;
	static Find(Outer: UObject, ResourceName: string): MagicLeapEmulatorSettings;
	static GetDefaultObject(): MagicLeapEmulatorSettings;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MagicLeapEmulatorSettings;
	static C(Other: UObject | any): MagicLeapEmulatorSettings;
}
...
declare class ABCharacterSetting extends UObject { 
	CharacterAssets: SoftObjectPath[];
	static Load(ResourceName: string): ABCharacterSetting;
	static Find(Outer: UObject, ResourceName: string): ABCharacterSetting;
	static GetDefaultObject(): ABCharacterSetting;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABCharacterSetting;
	static C(Other: UObject | any): ABCharacterSetting;
}
...
declare class ABAIController extends AIController { 
	BTAsset: BehaviorTree;
	BBAsset: BlackboardData;
	static GetDefaultObject(): ABAIController;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABAIController;
	static C(Other: UObject | any): ABAIController;
}

declare class ABAnimInstance extends AnimInstance { 
	CurrentPawnSpeed: number;
	IsInAir: boolean;
	IsDead: boolean;
	AttackMontage: AnimMontage;
	static Load(ResourceName: string): ABAnimInstance;
	static Find(Outer: UObject, ResourceName: string): ABAnimInstance;
	static GetDefaultObject(): ABAnimInstance;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABAnimInstance;
	AnimNotify_NextAttackCheck(): void;
	AnimNotify_AttackHitCheck(): void;
	static C(Other: UObject | any): ABAnimInstance;
}

declare class ABWeapon extends Actor { 
	AttackRange: number;
	AttackDamageMin: number;
	AttackDamageMax: number;
	AttackModifierMin: number;
	AttackModifierMax: number;
	AttackDamage: number;
	AttackModifier: number;
	WEAPON: SkeletalMeshComponent;
	static GetDefaultObject(): ABWeapon;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABWeapon;
	static C(Other: UObject | any): ABWeapon;
}

declare class ABCharacterStatComponent extends ActorComponent { 
	Level: number;
	CurrentHP: number;
	static Load(ResourceName: string): ABCharacterStatComponent;
	static Find(Outer: UObject, ResourceName: string): ABCharacterStatComponent;
	static GetDefaultObject(): ABCharacterStatComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABCharacterStatComponent;
	static C(Other: UObject | any): ABCharacterStatComponent;
}

declare type ECharacterState = 'PRIINIT' | 'LOADING' | 'READY' | 'DEAD' | 'ECharacterState_MAX';
declare var ECharacterState : { PRIINIT:'PRIINIT',LOADING:'LOADING',READY:'READY',DEAD:'DEAD',ECharacterState_MAX:'ECharacterState_MAX', };
declare class ABHUDWidget extends UserWidget { 
	HPBar: ProgressBar;
	ExpBar: ProgressBar;
	PlayerName: TextBlock;
	PlayerLevel: TextBlock;
	CurrentScore: TextBlock;
	HighScore: TextBlock;
	static Load(ResourceName: string): ABHUDWidget;
	static Find(Outer: UObject, ResourceName: string): ABHUDWidget;
	static GetDefaultObject(): ABHUDWidget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABHUDWidget;
	static C(Other: UObject | any): ABHUDWidget;
}

declare class ABGameplayWidget extends UserWidget { 
	ResumeButton: Button;
	ReturnToTitleButton: Button;
	RetryGameButton: Button;
	static Load(ResourceName: string): ABGameplayWidget;
	static Find(Outer: UObject, ResourceName: string): ABGameplayWidget;
	static GetDefaultObject(): ABGameplayWidget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABGameplayWidget;
	OnReturnToTitleClicked(): void;
	OnRetryGameClicked(): void;
	OnResumeClicked(): void;
	static C(Other: UObject | any): ABGameplayWidget;
}

declare class ABGameplayResultWidget extends ABGameplayWidget { 
	static Load(ResourceName: string): ABGameplayResultWidget;
	static Find(Outer: UObject, ResourceName: string): ABGameplayResultWidget;
	static GetDefaultObject(): ABGameplayResultWidget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABGameplayResultWidget;
	static C(Other: UObject | any): ABGameplayResultWidget;
}

declare class ABPlayerState extends PlayerState { 
	GameScore: number;
	GameHighScore: number;
	CharacterLevel: number;
	Exp: number;
	CharacterIndex: number;
	static GetDefaultObject(): ABPlayerState;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABPlayerState;
	static C(Other: UObject | any): ABPlayerState;
}

declare class ABPlayerController extends PlayerController { 
	HUDWidgetClass: UnrealEngineClass;
	MenuWidgetClass: UnrealEngineClass;
	ResultWidgetClass: UnrealEngineClass;
	HUDWidget: ABHUDWidget;
	ABPlayerState: ABPlayerState;
	MenuWidget: ABGameplayWidget;
	ResultWidget: ABGameplayResultWidget;
	static GetDefaultObject(): ABPlayerController;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABPlayerController;
	static C(Other: UObject | any): ABPlayerController;
}

declare class ABCharacter extends Character { 
	CurrentWeapon: ABWeapon;
	CHARACTERSTAT: ABCharacterStatComponent;
	...
	AttackRange: number;
	AttackRadius: number;
	ABAnim: ABAnimInstance;
	CurrentState: ECharacterState;
	bIsPlayer: boolean;
	ABAIController: ABAIController;
	ABPlayerController: ABPlayerController;
	DeadTimer: number;
	static GetDefaultObject(): ABCharacter;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABCharacter;
	OnAttackMontageEnded(Montage: AnimMontage,bInterrupted: boolean): void;
	static C(Other: UObject | any): ABCharacter;
}

declare class ABCharacterSelectWidget extends UserWidget { 
	CurrentIndex: number;
	MaxIndex: number;
	PrevButton: Button;
	NextButton: Button;
	...
	static Load(ResourceName: string): ABCharacterSelectWidget;
	static Find(Outer: UObject, ResourceName: string): ABCharacterSelectWidget;
	static GetDefaultObject(): ABCharacterSelectWidget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABCharacterSelectWidget;
	OnPrevClicked(): void;
	OnNextClicked(): void;
	OnConfirmClicked(): void;
	NextCharacter(bForward: boolean): void;
	static C(Other: UObject | any): ABCharacterSelectWidget;
}

declare class ABCharacterWidget extends UserWidget { 
	HPProgressBar: ProgressBar;
	static Load(ResourceName: string): ABCharacterWidget;
	static Find(Outer: UObject, ResourceName: string): ABCharacterWidget;
	static GetDefaultObject(): ABCharacterWidget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABCharacterWidget;
	static C(Other: UObject | any): ABCharacterWidget;
}

declare class ABGameInstance extends GameInstance { 
	ABCharacterTable: DataTable;
	static Load(ResourceName: string): ABGameInstance;
	static Find(Outer: UObject, ResourceName: string): ABGameInstance;
	static GetDefaultObject(): ABGameInstance;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABGameInstance;
	static C(Other: UObject | any): ABGameInstance;
}

declare class ABGameMode extends GameModeBase { 
	ScoreToClear: number;
	static GetDefaultObject(): ABGameMode;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABGameMode;
	static C(Other: UObject | any): ABGameMode;
}

declare class ABGameState extends GameStateBase { 
	TotalGameScore: number;
	bGameCleared: boolean;
	static GetDefaultObject(): ABGameState;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABGameState;
	static C(Other: UObject | any): ABGameState;
}

declare class ABItemBox extends Actor { 
	Trigger: BoxComponent;
	Box: StaticMeshComponent;
	EFFECT: ParticleSystemComponent;
	WeaponItemClass: UnrealEngineClass;
	static GetDefaultObject(): ABItemBox;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABItemBox;
	OnEffectFinished(PSystem: ParticleSystemComponent): void;
	...
	static C(Other: UObject | any): ABItemBox;
}

declare class ABPawn extends Pawn { 
	Capsule: CapsuleComponent;
	MESH: SkeletalMeshComponent;
	Movement: FloatingPawnMovement;
	SPRINGARM: SpringArmComponent;
	Camera: CameraComponent;
	static GetDefaultObject(): ABPawn;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABPawn;
	static C(Other: UObject | any): ABPawn;
}

declare class ABSaveGame extends SaveGame { 
	Level: number;
	Exp: number;
	PlayerName: string;
	HighScore: number;
	CharacterIndex: number;
	static Load(ResourceName: string): ABSaveGame;
	static Find(Outer: UObject, ResourceName: string): ABSaveGame;
	static GetDefaultObject(): ABSaveGame;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABSaveGame;
	static C(Other: UObject | any): ABSaveGame;
}

declare class ABSection extends Actor { 
	GateMeshes: StaticMeshComponent[];
	GateTriggers: BoxComponent[];
	MESH: StaticMeshComponent;
	Trigger: BoxComponent;
	bNoBattle: boolean;
	EnemySpawnTime: number;
	ItemBoxSpawnTime: number;
	static GetDefaultObject(): ABSection;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABSection;
	OnTriggerBeginOverlap(OverlappedComponent: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,OtherBodyIndex: number,bFromSweep: boolean,SweepResult: HitResult): void;
	OnKeyNPCDestroyed(DestroyedActor: Actor): void;
	OnGateTriggerBeginOverlap(OverlappedComponent: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,OtherBodyIndex: number,bFromSweep: boolean,SweepResult: HitResult): void;
	static C(Other: UObject | any): ABSection;
}

declare class ABUIPlayerController extends PlayerController { 
	UIWidgetClass: UnrealEngineClass;
	UIWidgetInstance: UserWidget;
	static GetDefaultObject(): ABUIPlayerController;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ABUIPlayerController;
	static C(Other: UObject | any): ABUIPlayerController;
}

declare class BTDecorator_IsInAttackRange extends BTDecorator { 
	static Load(ResourceName: string): BTDecorator_IsInAttackRange;
	static Find(Outer: UObject, ResourceName: string): BTDecorator_IsInAttackRange;
	static GetDefaultObject(): BTDecorator_IsInAttackRange;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTDecorator_IsInAttackRange;
	static C(Other: UObject | any): BTDecorator_IsInAttackRange;
}

declare class BTService_Detect extends BTService { 
	static Load(ResourceName: string): BTService_Detect;
	static Find(Outer: UObject, ResourceName: string): BTService_Detect;
	static GetDefaultObject(): BTService_Detect;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTService_Detect;
	static C(Other: UObject | any): BTService_Detect;
}

declare class BTTask_Attack extends BTTaskNode { 
	static Load(ResourceName: string): BTTask_Attack;
	static Find(Outer: UObject, ResourceName: string): BTTask_Attack;
	static GetDefaultObject(): BTTask_Attack;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_Attack;
	static C(Other: UObject | any): BTTask_Attack;
}

declare class BTTask_FindPatrolPos extends BTTaskNode { 
	static Load(ResourceName: string): BTTask_FindPatrolPos;
	static Find(Outer: UObject, ResourceName: string): BTTask_FindPatrolPos;
	static GetDefaultObject(): BTTask_FindPatrolPos;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_FindPatrolPos;
	static C(Other: UObject | any): BTTask_FindPatrolPos;
}

declare class BTTask_TurnToTarget extends BTTaskNode { 
	static Load(ResourceName: string): BTTask_TurnToTarget;
	static Find(Outer: UObject, ResourceName: string): BTTask_TurnToTarget;
	static GetDefaultObject(): BTTask_TurnToTarget;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_TurnToTarget;
	static C(Other: UObject | any): BTTask_TurnToTarget;
}

declare class DataActorComponent extends ActorComponent { 
	DataTableList: SoftObjectPath[];
	Level: number;
	CharacterTable: DataTable;
	static Load(ResourceName: string): DataActorComponent;
	static Find(Outer: UObject, ResourceName: string): DataActorComponent;
	static GetDefaultObject(): DataActorComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DataActorComponent;
	SetInfoData(EditLevel: number): void;
	static C(Other: UObject | any): DataActorComponent;
}

declare class MyActor extends Actor { 
	static GetDefaultObject(): MyActor;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): MyActor;
	static C(Other: UObject | any): MyActor;
}
...
declare class AppleImageUtilsBaseAsyncTaskBlueprintProxy extends UObject { 
	...
	static CreateProxyObjectForConvertToTIFF(SourceImage: Texture,bWantColor: boolean,bUseGpu: boolean): AppleImageUtilsBaseAsyncTaskBlueprintProxy;
	static CreateProxyObjectForConvertToPNG(SourceImage: Texture,bWantColor: boolean,bUseGpu: boolean): AppleImageUtilsBaseAsyncTaskBlueprintProxy;
	static CreateProxyObjectForConvertToJPEG(SourceImage: Texture,Quality: number,bWantColor: boolean,bUseGpu: boolean): AppleImageUtilsBaseAsyncTaskBlueprintProxy;
	static CreateProxyObjectForConvertToHEIF(SourceImage: Texture,Quality: number,bWantColor: boolean,bUseGpu: boolean): AppleImageUtilsBaseAsyncTaskBlueprintProxy;
