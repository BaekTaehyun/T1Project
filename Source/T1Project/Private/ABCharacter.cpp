...
AABCharacter::AABCharacter()
{
	...
	if (DefaultSetting->CharacterAssets.Num() > 0)
	{
		...
		{
			T1LOG(Warning, TEXT("Character Asset : %s"), *CharacterAsset.ToString());
		}
	}
	...
	GetMesh()->SetRelativeLocationAndRotation(FVector(.0f, .0f, -88.0f), FRotator(.0f, -90.0f, .0f));
	...
	static ConstructorHelpers::FClassFinder<UAnimInstance> WARRIOR(TEXT("/Game/Book/Animations/WarriorAnimBlueprint.WarriorAnimBlueprint_C"));
	if (WARRIOR.Succeeded())
	{
		GetMesh()->SetAnimInstanceClass(WARRIOR.Class);
	}
...
void AABCharacter::SetCharacterState(ECharacterState NewState)
{
	...
	case ECharacterState::LOADING:
	{
		...
		else
		{
			...
			T1LOG(Warning, TEXT("New NPC Level : %d"), FinalLevel);
	...
	case ECharacterState::READY:
	{
		...
		T1CHECK(nullptr != CharacterWidget);
...
void AABCharacter::BeginPlay()
{
	...
	else
	{
		...
		T1CHECK(nullptr != ABAIController);
	}
...
void AABCharacter::SetControlMode(EControlMode NewControlMode)
{
	...
	case EControlMode::DIABLO:
		...
		ArmLengthTo = 800.0f;
		ArmRotationTo = FRotator(-45.0f, .0f, .0f) ;
...
void AABCharacter::Tick(float DeltaTime)
{
	...
	{
	case EControlMode::DIABLO:
		if (DirectionToMove.SizeSquared() > .0f)
		{
...
float AABCharacter::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, AActor* DamageCauser)
{
	...
	if (CurrentState == ECharacterState::DEAD)
	{
		if (EventInstigator->IsPlayerController())
		{
			...
			T1CHECK(nullptr != ABPlayerController, 0.0f);
...
void AABCharacter::Attack()
{
	if (IsAttacking)
	{
		T1CHECK(FMath::IsWithinInclusive(CurrentCombo, 1, MaxCombo));
		if (CanNextCombo)
		{
			IsComboInputOn = true;
		}
...
void AABCharacter::AttackStartComboState()
{
	...
	T1CHECK(FMath::IsWithinInclusive<int32>(CurrentCombo, 0, MaxCombo - 1));
...
void AABCharacter::OnAssetLoadCompleted()
{
	...
	T1CHECK(LoadedAssetPath.IsValid());
