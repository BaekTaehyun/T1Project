...
#include "IT1ContentBrowserSingleton.h"

class FMenuBuilder;

class FT1FrontendFilterCategory
{
public:
	FT1FrontendFilterCategory(const FText& InTitle, const FText& InTooltip) : Title(InTitle), Tooltip(InTooltip) {}
...
class FT1FrontendFilter : public IFilter<FT1AssetFilterType>
{
public:
	FT1FrontendFilter(TSharedPtr<FT1FrontendFilterCategory> InCategory) : FilterCategory(InCategory) {}
	...
	DECLARE_DERIVED_EVENT( FT1FrontendFilter, IFilter<FT1AssetFilterType>::FChangedEvent, FChangedEvent );
	virtual FChangedEvent& OnChanged() override { return ChangedEvent; }

	TSharedPtr<FT1FrontendFilterCategory> GetCategory() { return FilterCategory; }
...
private:
	...
	TSharedPtr<FT1FrontendFilterCategory> FilterCategory;
};
