...
FT1CollectionAssetManagement::FT1CollectionAssetManagement()
{
	FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();

	// Register the notifications we need in order to keep things up-to-date
	OnCollectionRenamedHandle = CollectionManagerModule.Get().OnCollectionRenamed().AddRaw(this, &FT1CollectionAssetManagement::HandleCollectionRenamed);
	OnCollectionDestroyedHandle = CollectionManagerModule.Get().OnCollectionDestroyed().AddRaw(this, &FT1CollectionAssetManagement::HandleCollectionDestroyed);
	OnCollectionUpdatedHandle = CollectionManagerModule.Get().OnCollectionUpdated().AddRaw(this, &FT1CollectionAssetManagement::HandleCollectionUpdated);
	OnAssetsAddedHandle = CollectionManagerModule.Get().OnAssetsAdded().AddRaw(this, &FT1CollectionAssetManagement::HandleAssetsAddedToCollection);
	OnAssetsRemovedHandle = CollectionManagerModule.Get().OnAssetsRemoved().AddRaw(this, &FT1CollectionAssetManagement::HandleAssetsRemovedFromCollection);
}
...
void FT1CollectionAssetManagement::SetCurrentAssets(const TArray<FAssetData>& CurrentAssets)
{
...
void FT1CollectionAssetManagement::AddCurrentAssetsToCollection(FCollectionNameType InCollectionKey)
{
	FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();
...
void FT1CollectionAssetManagement::RemoveCurrentAssetsFromCollection(FCollectionNameType InCollectionKey)
{
	FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();
...
bool FT1CollectionAssetManagement::IsCollectionEnabled(FCollectionNameType InCollectionKey) const
{
...
ECheckBoxState FT1CollectionAssetManagement::GetCollectionCheckState(FCollectionNameType InCollectionKey) const
{
...
void FT1CollectionAssetManagement::UpdateAssetManagementState()
{
	FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();
...
void FT1CollectionAssetManagement::HandleCollectionRenamed(const FCollectionNameType& OriginalCollection, const FCollectionNameType& NewCollection)
{
...
void FT1CollectionAssetManagement::HandleCollectionUpdated(const FCollectionNameType& Collection)
{
	// Collection has changed in an unknown way - we need to update everything to be sure
	UpdateAssetManagementState();
}

void FT1CollectionAssetManagement::HandleCollectionDestroyed(const FCollectionNameType& Collection)
{
	AssetManagementState.Remove(Collection);
}

void FT1CollectionAssetManagement::HandleAssetsAddedToCollection(const FCollectionNameType& Collection, const TArray<FName>& AssetsAdded)
{
...
void FT1CollectionAssetManagement::HandleAssetsRemovedFromCollection(const FCollectionNameType& Collection, const TArray<FName>& AssetsRemoved)
{
