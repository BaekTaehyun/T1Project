...
struct FT1HistoryData
{
	...
	FT1SelectionData SelectionData;
};

/** The delegate for when history data should be applied */
DECLARE_DELEGATE_OneParam(FOnApplyHistoryData, const FT1HistoryData& /*Data*/);

/** The delegate for when history data should be updated */
DECLARE_DELEGATE_OneParam(FOnUpdateHistoryData, FT1HistoryData& /*Data*/);

/** The class responsible for managing all content browser history */
class FT1HistoryManager
{
public:
	/** Constructor */
	FT1HistoryManager();
...
private:
	...
	TArray<FT1HistoryData> HistoryData;
