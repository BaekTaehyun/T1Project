...
class FT1CollectionContextMenu : public TSharedFromThis<FT1CollectionContextMenu>
{
public:
	/** Constructor */
	FT1CollectionContextMenu(const TWeakPtr<SCollectionView>& InCollectionView);
...
private:
	...
	FReply ExecuteDestroyCollectionConfirmed(TArray<TSharedPtr<FT1CollectionItem>> CollectionList);
