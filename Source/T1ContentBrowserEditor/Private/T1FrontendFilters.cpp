...
{
public:
	typedef TRemoveReference<FT1AssetFilterType>::Type* FAssetFilterTypePtr;
...
FT1FrontendFilter_Text::FT1FrontendFilter_Text()
	: FT1FrontendFilter(nullptr)
	...
	, TextFilterExpressionEvaluator(ETextFilterExpressionEvaluatorMode::Complex)
{
	...
	OnCollectionCreatedHandle = CollectionManagerModule.Get().OnCollectionCreated().AddRaw(this, &FT1FrontendFilter_Text::HandleCollectionCreated);
	OnCollectionDestroyedHandle = CollectionManagerModule.Get().OnCollectionDestroyed().AddRaw(this, &FT1FrontendFilter_Text::HandleCollectionDestroyed);
	OnCollectionRenamedHandle = CollectionManagerModule.Get().OnCollectionRenamed().AddRaw(this, &FT1FrontendFilter_Text::HandleCollectionRenamed);
	OnCollectionUpdatedHandle = CollectionManagerModule.Get().OnCollectionUpdated().AddRaw(this, &FT1FrontendFilter_Text::HandleCollectionUpdated);
}
...
bool FT1FrontendFilter_Text::PassesFilter(FT1AssetFilterType InItem) const
{
...
FText FT1FrontendFilter_Text::GetRawFilterText() const
{
	return TextFilterExpressionEvaluator.GetFilterText();
}

void FT1FrontendFilter_Text::SetRawFilterText(const FText& InFilterText)
{
...
FText FT1FrontendFilter_Text::GetFilterErrorText() const
{
	return TextFilterExpressionEvaluator.GetFilterErrorText();
}

void FT1FrontendFilter_Text::SetIncludeClassName(const bool InIncludeClassName)
{
...
void FT1FrontendFilter_Text::SetIncludeAssetPath(const bool InIncludeAssetPath)
{
...
bool FT1FrontendFilter_Text::GetIncludeAssetPath() const
{
	return TextFilterExpressionContext->GetIncludeAssetPath();
}

void FT1FrontendFilter_Text::SetIncludeCollectionNames(const bool InIncludeCollectionNames)
{
...
bool FT1FrontendFilter_Text::GetIncludeCollectionNames() const
{
	return TextFilterExpressionContext->GetIncludeCollectionNames();
}

void FT1FrontendFilter_Text::HandleCollectionCreated(const FCollectionNameType& Collection)
{
	RebuildReferencedDynamicCollections();
...
void FT1FrontendFilter_Text::HandleCollectionDestroyed(const FCollectionNameType& Collection)
{
...
void FT1FrontendFilter_Text::HandleCollectionRenamed(const FCollectionNameType& OriginalCollection, const FCollectionNameType& NewCollection)
{
...
void FT1FrontendFilter_Text::HandleCollectionUpdated(const FCollectionNameType& Collection)
{
	RebuildReferencedDynamicCollections();
...
void FT1FrontendFilter_Text::RebuildReferencedDynamicCollections()
{
...
/////////////////////////////////////////
// FT1FrontendFilter_CheckedOut
/////////////////////////////////////////

FT1FrontendFilter_CheckedOut::FT1FrontendFilter_CheckedOut(TSharedPtr<FT1FrontendFilterCategory> InCategory) 
	: FT1FrontendFilter(InCategory)
{
	
}

void FT1FrontendFilter_CheckedOut::ActiveStateChanged(bool bActive)
{
	if(bActive)
	{
		RequestStatus();
...
bool FT1FrontendFilter_CheckedOut::PassesFilter(FT1AssetFilterType InItem) const
{
...
void FT1FrontendFilter_CheckedOut::RequestStatus()
{
	...
	if ( ISourceControlModule::Get().IsEnabled() )
	{
		...
		SourceControlProvider.Execute(UpdateStatusOperation, EConcurrency::Asynchronous, FSourceControlOperationComplete::CreateSP(this, &FT1FrontendFilter_CheckedOut::SourceControlOperationComplete) );
	}
}

void FT1FrontendFilter_CheckedOut::SourceControlOperationComplete(const FSourceControlOperationRef& InOperation, ECommandResult::Type InResult)
{
	BroadcastChangedEvent();
}
...
FT1FrontendFilter_Modified::FT1FrontendFilter_Modified(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
	, bIsCurrentlyActive(false)
{
	UPackage::PackageDirtyStateChangedEvent.AddRaw(this, &FT1FrontendFilter_Modified::OnPackageDirtyStateUpdated);
}

FT1FrontendFilter_Modified::~FT1FrontendFilter_Modified()
{
	UPackage::PackageDirtyStateChangedEvent.RemoveAll(this);
}

void FT1FrontendFilter_Modified::ActiveStateChanged(bool bActive)
{
	bIsCurrentlyActive = bActive;
}

bool FT1FrontendFilter_Modified::PassesFilter(FT1AssetFilterType InItem) const
{
...
void FT1FrontendFilter_Modified::OnPackageDirtyStateUpdated(UPackage* Package)
{
...
/////////////////////////////////////////
// FT1FrontendFilter_ReplicatedBlueprint
/////////////////////////////////////////

bool FT1FrontendFilter_ReplicatedBlueprint::PassesFilter(FT1AssetFilterType InItem) const
{
...
FString FT1FrontendFilter_ArbitraryComparisonOperation::GetName() const
{
	return TEXT("CompareTags");
}

FText FT1FrontendFilter_ArbitraryComparisonOperation::GetDisplayName() const
{
...
FText FT1FrontendFilter_ArbitraryComparisonOperation::GetToolTipText() const
{
...
bool FT1FrontendFilter_ArbitraryComparisonOperation::PassesFilter(FT1AssetFilterType InItem) const
{
	FString TagValue;
...
void FT1FrontendFilter_ArbitraryComparisonOperation::ModifyContextMenu(FMenuBuilder& MenuBuilder)
{
	FUIAction Action;
	...
	TSharedRef<SWidget> KeyWidget =
		...
		.Text_Raw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::GetKeyValueAsText)
		.OnTextCommitted_Raw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::OnKeyValueTextCommitted)
		.MinDesiredWidth(100.0f);
	TSharedRef<SWidget> ValueWidget = SNew(SEditableTextBox)
		.Text_Raw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::GetTargetValueAsText)
		.OnTextCommitted_Raw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::OnTargetValueTextCommitted)
		.MinDesiredWidth(100.0f);
...
#define UE_SET_COMP_OP(Operation) \
	MenuBuilder.AddMenuEntry(FText::AsCultureInvariant(ConvertOperationToString(Operation)), \
		...
		FSlateIcon(), \
		FUIAction(FExecuteAction::CreateRaw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::SetComparisonOperation, Operation), FCanExecuteAction(), FIsActionChecked::CreateRaw(this, &FT1FrontendFilter_ArbitraryComparisonOperation::IsComparisonOperationEqualTo, Operation)), \
		NAME_None, \
...
void FT1FrontendFilter_ArbitraryComparisonOperation::SaveSettings(const FString& IniFilename, const FString& IniSection, const FString& SettingsString) const
{
...
void FT1FrontendFilter_ArbitraryComparisonOperation::LoadSettings(const FString& IniFilename, const FString& IniSection, const FString& SettingsString)
{
...
void FT1FrontendFilter_ArbitraryComparisonOperation::SetComparisonOperation(ETextFilterComparisonOperation NewOp)
{
	ComparisonOp = NewOp;
	BroadcastChangedEvent();
}

bool FT1FrontendFilter_ArbitraryComparisonOperation::IsComparisonOperationEqualTo(ETextFilterComparisonOperation TestOp) const
{
	return (ComparisonOp == TestOp);
}

FText FT1FrontendFilter_ArbitraryComparisonOperation::GetKeyValueAsText() const
{
	return FText::FromName(TagName);
}

FText FT1FrontendFilter_ArbitraryComparisonOperation::GetTargetValueAsText() const
{
	return FText::AsCultureInvariant(TargetTagValue);
}

void FT1FrontendFilter_ArbitraryComparisonOperation::OnKeyValueTextCommitted(const FText& InText, ETextCommit::Type InCommitType)
{
	if (!InText.IsEmpty())
	{
...
void FT1FrontendFilter_ArbitraryComparisonOperation::OnTargetValueTextCommitted(const FText& InText, ETextCommit::Type InCommitType)
{
	TargetTagValue = InText.ToString();
	BroadcastChangedEvent();
}

FString FT1FrontendFilter_ArbitraryComparisonOperation::ConvertOperationToString(ETextFilterComparisonOperation Op)
{
	switch (Op)
	{
...
/////////////////////////////////////////
// FT1FrontendFilter_ShowOtherDevelopers
/////////////////////////////////////////

FT1FrontendFilter_ShowOtherDevelopers::FT1FrontendFilter_ShowOtherDevelopers(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
...
void FT1FrontendFilter_ShowOtherDevelopers::SetCurrentFilter(const FARFilter& InFilter)
{
...
bool FT1FrontendFilter_ShowOtherDevelopers::PassesFilter(FT1AssetFilterType InItem) const
{
...
void FT1FrontendFilter_ShowOtherDevelopers::SetShowOtherDeveloperAssets(bool bValue)
{
...
bool FT1FrontendFilter_ShowOtherDevelopers::GetShowOtherDeveloperAssets() const
{
	return bShowOtherDeveloperAssets;
}

/////////////////////////////////////////
// FT1FrontendFilter_ShowRedirectors
/////////////////////////////////////////

FT1FrontendFilter_ShowRedirectors::FT1FrontendFilter_ShowRedirectors(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
{
...
void FT1FrontendFilter_ShowRedirectors::SetCurrentFilter(const FARFilter& InFilter)
{
	bAreRedirectorsInBaseFilter = InFilter.ClassNames.Contains(RedirectorClassName);
}

bool FT1FrontendFilter_ShowRedirectors::PassesFilter(FT1AssetFilterType InItem) const
{
...
FT1FrontendFilter_InUseByLoadedLevels::FT1FrontendFilter_InUseByLoadedLevels(TSharedPtr<FT1FrontendFilterCategory> InCategory) 
	: FT1FrontendFilter(InCategory)
	, bIsCurrentlyActive(false)
{
	FEditorDelegates::MapChange.AddRaw(this, &FT1FrontendFilter_InUseByLoadedLevels::OnEditorMapChange);

	IAssetTools& AssetTools = FAssetToolsModule::GetModule().Get();
	AssetTools.OnAssetPostRename().AddRaw(this, &FT1FrontendFilter_InUseByLoadedLevels::OnAssetPostRename);
}

FT1FrontendFilter_InUseByLoadedLevels::~FT1FrontendFilter_InUseByLoadedLevels()
{
...
void FT1FrontendFilter_InUseByLoadedLevels::ActiveStateChanged( bool bActive )
{
	bIsCurrentlyActive = bActive;
...
void FT1FrontendFilter_InUseByLoadedLevels::OnAssetPostRename(const TArray<FAssetRenameData>& AssetsAndNames)
{
	// Update the tags identifying objects currently used by loaded levels
	ObjectTools::TagInUseObjects(ObjectTools::SO_LoadedLevels);
}

bool FT1FrontendFilter_InUseByLoadedLevels::PassesFilter(FT1AssetFilterType InItem) const
{
...
void FT1FrontendFilter_InUseByLoadedLevels::OnEditorMapChange( uint32 MapChangeFlags )
{
...
FT1FrontendFilter_UsedInAnyLevel::FT1FrontendFilter_UsedInAnyLevel(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
{
...
FT1FrontendFilter_UsedInAnyLevel::~FT1FrontendFilter_UsedInAnyLevel()
{
	AssetRegistry = nullptr;
}

void FT1FrontendFilter_UsedInAnyLevel::ActiveStateChanged(bool bActive)
{
...
bool FT1FrontendFilter_UsedInAnyLevel::PassesFilter(FT1AssetFilterType InItem) const
{
	return LevelsDependencies.Contains(InItem.PackageName);
}

/////////////////////////////////////////
// FT1FrontendFilter_NotUsedInAnyLevel
/////////////////////////////////////////

FT1FrontendFilter_NotUsedInAnyLevel::FT1FrontendFilter_NotUsedInAnyLevel(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
{
	// Prepare asset registry.
	FAssetRegistryModule& AssetRegistryModule = FModuleManager::LoadModuleChecked<FAssetRegistryModule>(TEXT("AssetRegistry"));
...
FT1FrontendFilter_NotUsedInAnyLevel::~FT1FrontendFilter_NotUsedInAnyLevel()
{
	AssetRegistry = nullptr;
}

void FT1FrontendFilter_NotUsedInAnyLevel::ActiveStateChanged(bool bActive)
{
	LevelsDependencies.Empty();
...
bool FT1FrontendFilter_NotUsedInAnyLevel::PassesFilter(FT1AssetFilterType InItem) const
{
	return !LevelsDependencies.Contains(InItem.PackageName);
}
...
FT1FrontendFilter_Recent::FT1FrontendFilter_Recent(TSharedPtr<FT1FrontendFilterCategory> InCategory)
	: FT1FrontendFilter(InCategory)
	, bIsCurrentlyActive(false)
{
	UContentBrowserSettings::OnSettingChanged().AddRaw(this, &FT1FrontendFilter_Recent::ResetFilter);
}

FT1FrontendFilter_Recent::~FT1FrontendFilter_Recent()
{
	UContentBrowserSettings::OnSettingChanged().RemoveAll(this);
}

void FT1FrontendFilter_Recent::ActiveStateChanged(bool bActive)
{
	bIsCurrentlyActive = bActive;
}

bool FT1FrontendFilter_Recent::PassesFilter(FT1AssetFilterType InItem) const
{
	FString PackagePath = InItem.PackageName.ToString();
	T1ContentBrowserEditor& CBModule = FModuleManager::LoadModuleChecked<T1ContentBrowserEditor>(TEXT("T1ContentBrowserEditor"));
...
void FT1FrontendFilter_Recent::ResetFilter(FName InName)
{
	if (InName == T1ContentBrowserEditor::NumberOfRecentAssetsName)
	{
		BroadcastChangedEvent();
	}
}