...
#include "T1CollectionAssetManagement.h"
...
FT1AssetContextMenu::FT1AssetContextMenu(const TWeakPtr<ST1AssetView>& InAssetView)
...
void FT1AssetContextMenu::BindCommands(TSharedPtr< FUICommandList >& Commands)
{
	Commands->MapAction(FGenericCommands::Get().Duplicate, FUIAction(
		FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteDuplicate),
		FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteDuplicate),
		FIsActionChecked(),
		FIsActionButtonVisible::CreateSP(this, &FT1AssetContextMenu::CanExecuteDuplicate)
		));

	Commands->MapAction(FGlobalEditorCommonCommands::Get().FindInContentBrowser, FUIAction(
		FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteSyncToAssetTree),
		FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteSyncToAssetTree)
		));
}

TSharedRef<SWidget> FT1AssetContextMenu::MakeContextMenu(const TArray<FAssetData>& InSelectedAssets, const FT1SourcesData& InSourcesData, TSharedPtr< FUICommandList > InCommandList)
{
	...
	TArray<FT1ContentBrowserMenuExtender_SelectedAssets> MenuExtenderDelegates = ContentBrowserModule.GetAllAssetViewContextMenuExtenders();
...
void FT1AssetContextMenu::SetSelectedAssets(const TArray<FAssetData>& InSelectedAssets)
{
	SelectedAssets = InSelectedAssets;
}

void FT1AssetContextMenu::SetOnFindInAssetTreeRequested(const FT1OnFindInAssetTreeRequested& InOnFindInAssetTreeRequested)
{
	OnFindInAssetTreeRequested = InOnFindInAssetTreeRequested;
}

void FT1AssetContextMenu::SetOnRenameRequested(const FOnRenameRequested& InOnRenameRequested)
{
	OnRenameRequested = InOnRenameRequested;
}

void FT1AssetContextMenu::SetOnRenameFolderRequested(const FOnRenameFolderRequested& InOnRenameFolderRequested)
{
	OnRenameFolderRequested = InOnRenameFolderRequested;
}

void FT1AssetContextMenu::SetOnDuplicateRequested(const FOnDuplicateRequested& InOnDuplicateRequested)
{
	OnDuplicateRequested = InOnDuplicateRequested;
}

void FT1AssetContextMenu::SetOnAssetViewRefreshRequested(const FOnAssetViewRefreshRequested& InOnAssetViewRefreshRequested)
{
	OnAssetViewRefreshRequested = InOnAssetViewRefreshRequested;
}

bool FT1AssetContextMenu::AddImportedAssetMenuOptions(FMenuBuilder& MenuBuilder)
{
	if (AreImportedAssetActionsVisible())
	{
		...
		MenuBuilder.BeginSection("ImportedAssetActions", LOCTEXT("ImportedAssetActionsMenuHeading", "Imported Asset"));
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.ReimportAsset"),
				FUIAction(
					FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteReimport),
					FCanExecuteAction()
					)
				);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.OpenSourceLocation"),
				FUIAction(
					FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteFindSourceInExplorer, ResolvedFilePaths),
					FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteImportedAssetActions, ResolvedFilePaths)
					)
				);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.OpenInExternalEditor"),
				FUIAction(
					FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteOpenInExternalEditor, ResolvedFilePaths),
					FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteImportedAssetActions, ResolvedFilePaths)
					)
				);
		}
...
bool FT1AssetContextMenu::AddCommonMenuOptions(FMenuBuilder& MenuBuilder)
{
	int32 NumAssetItems, NumClassItems;
	T1ContentBrowserUtils::CountItemTypes(SelectedAssets, NumAssetItems, NumClassItems);
	...
	MenuBuilder.BeginSection("CommonAssetActions", LOCTEXT("CommonAssetActionsMenuHeading", "Common"));
	{
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.Edit"),
			FUIAction( FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteEditAsset) )
			);
		...
		if (NumAssetItems > 0)
		{
			...
			MenuBuilder.AddMenuEntry(FGenericCommands::Get().Rename, NAME_None,
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.Rename")
				);
			...
			MenuBuilder.AddMenuEntry(FGenericCommands::Get().Duplicate, NAME_None,
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.Duplicate")
				);

			// Save
			MenuBuilder.AddMenuEntry(FT1ContentBrowserCommands::Get().SaveSelectedAsset, NAME_None,
			...
			MenuBuilder.AddMenuEntry(FGenericCommands::Get().Delete, NAME_None,
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.Delete")
				);
			...
			MenuBuilder.AddSubMenu(
				...
				FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::MakeAssetActionsSubMenu),
				FUIAction(
					FExecuteAction(),
					FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteAssetActions )
					),
				NAME_None,
				EUserInterfaceActionType::Button,
				false, 
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions")
				);
			...
			if (NumClassItems == 0)
			{
				...
				MenuBuilder.AddSubMenu(
					...
					FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::MakeAssetLocalizationSubMenu),
					FUIAction(),
					NAME_None,
					EUserInterfaceActionType::Button,
					false,
					FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetLocalization")
					);
			}
		}
	}
...
void FT1AssetContextMenu::AddExploreMenuOptions(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.BeginSection("AssetContextExploreMenuOptions", LOCTEXT("AssetContextExploreMenuOptionsHeading", "Explore"));
	{
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteFindInExplorer ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteFindInExplorer )
				)
			);
	}
	MenuBuilder.EndSection();
...
void FT1AssetContextMenu::MakeAssetActionsSubMenu(FMenuBuilder& MenuBuilder)
{	
	...
	MenuBuilder.AddMenuEntry(
		...
		FUIAction(
			FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteCreateBlueprintUsing),
			FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteCreateBlueprintUsing)
		)
	);
	...
	if (SelectedAssets.Num() == 1 && AssetToolsModule.Get().AssetUsesGenericThumbnail(SelectedAssets[0]))
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.CreateThumbnail"),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteCaptureThumbnail),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteCaptureThumbnail)
			)
		);
	}
	...
	if (CanClearCustomThumbnails())
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.DeleteThumbnail"),
			FUIAction( FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteClearThumbnail) ) 
			);
	}
	...
	MenuBuilder.BeginSection("AssetContextFindActions", LOCTEXT("AssetContextFindActionsMenuHeading", "Find"));
	{
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteFindAssetInWorld),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteFindAssetInWorld)
				)
			);
	}
	MenuBuilder.EndSection();
	...
	MenuBuilder.BeginSection("AssetContextMoveActions", LOCTEXT("AssetContextMoveActionsMenuHeading", "Move"));
	{
		...
		if (bHasExportableAssets)
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteExport ) )
				);
			...
			if (SelectedAssets.Num() > 1)
			{
				MenuBuilder.AddMenuEntry(
					...
					FSlateIcon(),
					FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteBulkExport ) )
					);
			}
		}
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteMigrateAsset ) )
			);
	}
	MenuBuilder.EndSection();
	...
	MenuBuilder.BeginSection("AssetContextAdvancedActions", LOCTEXT("AssetContextAdvancedActionsMenuHeading", "Advanced"));
	{
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteReload),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteReload)
			)
		);
		...
		if (CanExecuteConsolidate())
		{
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteConsolidate)
				)
				);
		}
		...
		if (bCanUsePropertyMatrix)
		{
			...
			DynamicTooltipGetter.BindSP(this, &FT1AssetContextMenu::GetExecutePropertyMatrixTooltip);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecutePropertyMatrix),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecutePropertyMatrix)
				)
				);
		}
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteShowAssetMetaData),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteShowAssetMetaData)
			)
		);
		...
		if (GetDefault<UEditorExperimentalSettings>()->bContextMenuChunkAssignments)
		{
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction( FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteAssignChunkID) )
				);
			...
			MenuBuilder.AddSubMenu(
				...
				FNewMenuDelegate::CreateRaw(this, &FT1AssetContextMenu::MakeChunkIDListMenu)
				);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction( FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteRemoveAllChunkID) )
				);
		}
	}
	MenuBuilder.EndSection();
	...
	if (GetDefault<UEditorExperimentalSettings>()->bTextAssetFormatSupport)
	{
		MenuBuilder.BeginSection("AssetContextTextAssetFormatActions", LOCTEXT("AssetContextTextAssetFormatActionsHeading", "Text Assets"));
		{
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExportSelectedAssetsToText))
			);
		}
		MenuBuilder.EndSection();
	}
...
void FT1AssetContextMenu::ExportSelectedAssetsToText()
{
...
bool FT1AssetContextMenu::CanExportSelectedAssetsToText() const
{
	return true;
}

bool FT1AssetContextMenu::CanExecuteAssetActions() const
{
	return !bAtLeastOneClassSelected;
}

void FT1AssetContextMenu::MakeAssetLocalizationSubMenu(FMenuBuilder& MenuBuilder)
{
	...
	// Build up the list of cultures already used
	{
		...
		for (const FAssetData& Asset : SelectedAssets)
		{
			...
			if (T1ContentBrowserUtils::IsEngineFolder(AssetPath))
			{
		...
		MenuBuilder.BeginSection(NAME_None, LOCTEXT("LocalizationIdHeading", "Localization ID"));
		{
			...
			if (SelectedAssets.Num() == 1)
			{
				...
				MenuBuilder.AddMenuEntry(
					...
					FSlateIcon(),
					FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteCopyTextToClipboard, LocalizationId))
					);
			}
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteResetLocalizationId))
				);
		}
		MenuBuilder.EndSection();
	}
		...
		if (FPackageName::DoesPackageExist(SelectedAssets[0].PackageName.ToString(), nullptr, &PackageFilename))
		{
			MenuBuilder.BeginSection(NAME_None, LOCTEXT("LocalizationCacheHeading", "Localization Cache"));
			{
				...
				MenuBuilder.AddMenuEntry(
					...
					FSlateIcon(),
					FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteShowLocalizationCache, PackageFilename))
					);
			}
			MenuBuilder.EndSection();
		}
	...
	if (SourceAssetsState.CurrentAssets.Num() > 0)
	{
		MenuBuilder.BeginSection(NAME_None, LOCTEXT("ManageSourceAssetHeading", "Manage Source Asset"));
		{
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "SystemWideCommands.FindInContentBrowser"),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteFindInAssetTree, SourceAssetsState.CurrentAssets.Array()))
				);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.Edit"),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteOpenEditorsForAssets, SourceAssetsState.CurrentAssets.Array()))
				);
		}
		MenuBuilder.EndSection();
	}
	...
	if (SourceAssetsState.SelectedAssets.Num() > 0)
	{
		MenuBuilder.BeginSection(NAME_None, LOCTEXT("ManageLocalizedAssetHeading", "Manage Localized Asset"));
		{
			MenuBuilder.AddSubMenu(
				...
				FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::MakeCreateLocalizedAssetSubMenu, SourceAssetsState.SelectedAssets, LocalizedAssetsState),
				FUIAction(),
				NAME_None,
				EUserInterfaceActionType::Button,
				false,
			...
			if (NumLocalizedAssets > 0)
			{
				MenuBuilder.AddSubMenu(
					...
					FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::MakeShowLocalizedAssetSubMenu, LocalizedAssetsState),
					FUIAction(),
					NAME_None,
					EUserInterfaceActionType::Button,
					false,
				...
				MenuBuilder.AddSubMenu(
					...
					FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::MakeEditLocalizedAssetSubMenu, LocalizedAssetsState),
					FUIAction(),
					NAME_None,
					EUserInterfaceActionType::Button,
					false,
...
void FT1AssetContextMenu::MakeCreateLocalizedAssetSubMenu(FMenuBuilder& MenuBuilder, TSet<FName> InSelectedSourceAssets, TArray<FLocalizedAssetsState> InLocalizedAssetsState)
{
	for (const FLocalizedAssetsState& LocalizedAssetsStateForCulture : InLocalizedAssetsState)
	{
		...
		if (LocalizedAssetsStateForCulture.CurrentAssets.Num() < InSelectedSourceAssets.Num())
		{
			MenuBuilder.AddMenuEntry(
				...
				FText::GetEmpty(),
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteCreateLocalizedAsset, InSelectedSourceAssets, LocalizedAssetsStateForCulture))
				);
		}
	}
}

void FT1AssetContextMenu::MakeShowLocalizedAssetSubMenu(FMenuBuilder& MenuBuilder, TArray<FLocalizedAssetsState> InLocalizedAssetsState)
{
	for (const FLocalizedAssetsState& LocalizedAssetsStateForCulture : InLocalizedAssetsState)
	{
		if (LocalizedAssetsStateForCulture.CurrentAssets.Num() > 0)
		{
			MenuBuilder.AddMenuEntry(
				...
				FText::GetEmpty(),
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteFindInAssetTree, LocalizedAssetsStateForCulture.CurrentAssets.Array()))
				);
		}
	}
}

void FT1AssetContextMenu::MakeEditLocalizedAssetSubMenu(FMenuBuilder& MenuBuilder, TArray<FLocalizedAssetsState> InLocalizedAssetsState)
{
	for (const FLocalizedAssetsState& LocalizedAssetsStateForCulture : InLocalizedAssetsState)
	{
		if (LocalizedAssetsStateForCulture.CurrentAssets.Num() > 0)
		{
			MenuBuilder.AddMenuEntry(
				...
				FText::GetEmpty(),
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteOpenEditorsForAssets, LocalizedAssetsStateForCulture.CurrentAssets.Array()))
				);
		}
	}
}

void FT1AssetContextMenu::ExecuteCreateLocalizedAsset(TSet<FName> InSelectedSourceAssets, FLocalizedAssetsState InLocalizedAssetsStateForCulture)
{
...
void FT1AssetContextMenu::ExecuteFindInAssetTree(TArray<FName> InAssets)
{
	FAssetRegistryModule& AssetRegistryModule = FModuleManager::LoadModuleChecked<FAssetRegistryModule>(TEXT("AssetRegistry"));
...
void FT1AssetContextMenu::ExecuteOpenEditorsForAssets(TArray<FName> InAssets)
{
	FAssetEditorManager::Get().OpenEditorsForAssets(InAssets);
}

bool FT1AssetContextMenu::AddReferenceMenuOptions(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.BeginSection("AssetContextReferences", LOCTEXT("ReferencesMenuHeading", "References"));
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteCopyReference ) )
			);
	}
	MenuBuilder.EndSection();
...
bool FT1AssetContextMenu::AddDocumentationMenuOptions(FMenuBuilder& MenuBuilder)
{
			...
			if( FSourceCodeNavigation::FindClassHeaderPath( SelectedClass, ClassHeaderPath ) && IFileManager::Get().FileSize( *ClassHeaderPath ) != INDEX_NONE )
			{
				...
				MenuBuilder.BeginSection( "AssetCode"/*, LOCTEXT("AssetCodeHeading", "C++")*/ );
				{
					MenuBuilder.AddMenuEntry(
						...
						FSlateIcon(FEditorStyle::GetStyleSetName(), "T1ContentBrowser.AssetActions.GoToCodeForAsset"),
						FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToCodeForAsset, SelectedClass ) )
						);
				}
				MenuBuilder.EndSection();
			}
					...
					if (bIsBlueprint)
					{
						if (!DocumentationLink.IsEmpty())
						{
							MenuBuilder.AddMenuEntry(
								...
								FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToDocsForAsset, SelectedClass ) )
								);
						}
						...
						case BPTYPE_FunctionLibrary:
							MenuBuilder.AddMenuEntry(
								...
								FSlateIcon(FEditorStyle::GetStyleSetName(), "HelpIcon.Hovered" ),
								FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToDocsForAsset, UBlueprint::StaticClass(), FString(TEXT("UBlueprint_FunctionLibrary")) ) )
								);
							break;
						case BPTYPE_Interface:
							MenuBuilder.AddMenuEntry(
								...
								FSlateIcon(FEditorStyle::GetStyleSetName(), "HelpIcon.Hovered" ),
								FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToDocsForAsset, UBlueprint::StaticClass(), FString(TEXT("UBlueprint_Interface")) ) )
								);
							break;
						case BPTYPE_MacroLibrary:
							MenuBuilder.AddMenuEntry(
								...
								FSlateIcon(FEditorStyle::GetStyleSetName(), "HelpIcon.Hovered" ),
								FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToDocsForAsset, UBlueprint::StaticClass(), FString(TEXT("UBlueprint_Macro")) ) )
								);
							break;
						default:
							MenuBuilder.AddMenuEntry(
								...
								FSlateIcon(FEditorStyle::GetStyleSetName(), "HelpIcon.Hovered" ),
								FUIAction( FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteGoToDocsForAsset, UBlueprint::StaticClass(), FString(TEXT("UBlueprint")) ) )
								);
						}
					}
					else
...
bool FT1AssetContextMenu::AddAssetTypeMenuOptions(FMenuBuilder& MenuBuilder)
{
	...
	if ( T1ContentBrowserUtils::LoadAssetsIfNeeded(ObjectPaths, SelectedObjects) )
	{
...
bool FT1AssetContextMenu::AddSourceControlMenuOptions(FMenuBuilder& MenuBuilder)
{
	...
	if ( ISourceControlModule::Get().IsEnabled() )
	{
		...
		MenuBuilder.AddSubMenu(
			...
			FNewMenuDelegate::CreateSP(this, &FT1AssetContextMenu::FillSourceControlSubMenu),
			FUIAction(
				FExecuteAction(),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSourceControlActions )
				),
			NAME_None,
			EUserInterfaceActionType::Button,
			false,
	...
	else
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteEnableSourceControl ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSourceControlActions )
				)
			);
	}
	...
	if (CanExecuteDiffSelected())
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteDiffSelected)
			)
		);
	}
...
void FT1AssetContextMenu::FillSourceControlSubMenu(FMenuBuilder& MenuBuilder)
{
	...
	if( CanExecuteSCCMerge() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteSCCMerge),
				FCanExecuteAction::CreateSP(this, &FT1AssetContextMenu::CanExecuteSCCMerge)
			)
		);
	}
	...
	if( CanExecuteSCCSync() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCSync ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCSync )
			)
		);
	}
	...
	if ( CanExecuteSCCCheckOut() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCCheckOut ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCCheckOut )
			)
		);
	}
	...
	if ( CanExecuteSCCOpenForAdd() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCOpenForAdd ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCOpenForAdd )
			)
		);
	}
	...
	if ( CanExecuteSCCCheckIn() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCCheckIn ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCCheckIn )
			)
		);
	}
	...
	MenuBuilder.AddMenuEntry(
		...
		FUIAction(
			FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCRefresh ),
			FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCRefresh )
			)
		);
	...
	if( CanExecuteSCCHistory() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCHistory ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCHistory )
			)
		);
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(FEditorStyle::GetStyleSetName(), "SourceControl.Actions.Diff"),
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCDiffAgainstDepot ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCDiffAgainstDepot )
			)
		);	
	}
	...
	if( CanExecuteSCCRevert() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteSCCRevert ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteSCCRevert )
			)
		);
	}
...
bool FT1AssetContextMenu::CanExecuteSourceControlActions() const
{
	return !bAtLeastOneClassSelected;
}

bool FT1AssetContextMenu::AddCollectionMenuOptions(FMenuBuilder& MenuBuilder)
{
	class FManageCollectionsContextMenu
	{
	public:
		static void CreateManageCollectionsSubMenu(FMenuBuilder& SubMenuBuilder, TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement)
		{
		...
		static void CreateManageCollectionsSubMenu(FMenuBuilder& SubMenuBuilder, TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement, TArray<FCollectionNameType> AvailableCollections)
		{
			FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();
	...
	private:
		static bool IsCollectionEnabled(TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement, FCollectionNameType InCollectionKey)
		{
			return QuickAssetManagement->IsCollectionEnabled(InCollectionKey);
		}

		static ECheckBoxState GetCollectionCheckState(TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement, FCollectionNameType InCollectionKey)
		{
			return QuickAssetManagement->GetCollectionCheckState(InCollectionKey);
		}

		static void OnCollectionClicked(TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement, FCollectionNameType InCollectionKey)
		{
	...
	{
		TSharedRef<FT1CollectionAssetManagement> QuickAssetManagement = MakeShareable(new FT1CollectionAssetManagement());
	...
	if ( T1SourcesData.Collections.Num() == 1 && !T1SourcesData.IsDynamicCollection() )
	{
		MenuBuilder.AddMenuEntry(
			FText::Format(LOCTEXT("RemoveFromCollectionFmt", "Remove From {0}"), FText::FromName(T1SourcesData.Collections[0].Name)),
			LOCTEXT("RemoveFromCollection_ToolTip", "Removes the selected asset from the current collection."),
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1AssetContextMenu::ExecuteRemoveFromCollection ),
				FCanExecuteAction::CreateSP( this, &FT1AssetContextMenu::CanExecuteRemoveFromCollection )
				)
			);
...
bool FT1AssetContextMenu::AreImportedAssetActionsVisible() const
{
	FAssetToolsModule& AssetToolsModule = FModuleManager::Get().LoadModuleChecked<FAssetToolsModule>("AssetTools");
...
bool FT1AssetContextMenu::CanExecuteImportedAssetActions(const TArray<FString> ResolvedFilePaths) const
{
...
void FT1AssetContextMenu::ExecuteReimport()
{
...
void FT1AssetContextMenu::ExecuteFindSourceInExplorer(const TArray<FString> ResolvedFilePaths)
{
...
void FT1AssetContextMenu::ExecuteOpenInExternalEditor(const TArray<FString> ResolvedFilePaths)
{
...
void FT1AssetContextMenu::GetSelectedAssetsByClass(TMap<UClass*, TArray<UObject*> >& OutSelectedAssetsByClass) const
{
...
void FT1AssetContextMenu::GetSelectedAssetSourceFilePaths(TArray<FString>& OutFilePaths) const
{
	OutFilePaths.Empty();
...
void FT1AssetContextMenu::ExecuteSyncToAssetTree()
{
...
void FT1AssetContextMenu::ExecuteFindInExplorer()
{
	for (int32 AssetIdx = 0; AssetIdx < SelectedAssets.Num(); ++AssetIdx)
	{
...
void FT1AssetContextMenu::ExecuteCreateBlueprintUsing()
{
	if(SelectedAssets.Num() == 1)
	{
...
void FT1AssetContextMenu::GetSelectedAssets(TArray<UObject*>& Assets, bool SkipRedirectors) const
{
	for (int32 AssetIdx = 0; AssetIdx < SelectedAssets.Num(); ++AssetIdx)
	{
...
void FT1AssetContextMenu::ExecuteFindAssetInWorld()
{
...
void FT1AssetContextMenu::ExecutePropertyMatrix()
{
...
void FT1AssetContextMenu::ExecuteShowAssetMetaData()
{
	for (const FAssetData& AssetData : SelectedAssets)
	{
			...
			if (TagValues)
			{
				...
				TSharedPtr< SWindow > Window = SNew(SWindow)
					...
					[
						...
						[
							SNew(T1SMetaDataView, *TagValues)
						]
					];
...
void FT1AssetContextMenu::ExecuteEditAsset()
{
	TMap<UClass*, TArray<UObject*> > SelectedAssetsByClass;
	GetSelectedAssetsByClass(SelectedAssetsByClass);
...
void FT1AssetContextMenu::ExecuteSaveAsset()
{
	TArray<UPackage*> PackagesToSave;
...
void FT1AssetContextMenu::ExecuteDiffSelected() const
{
...
void FT1AssetContextMenu::ExecuteDuplicate() 
{
...
void FT1AssetContextMenu::ExecuteRename()
{
...
void FT1AssetContextMenu::ExecuteDelete()
{
	...
	if(SelectedFolders.Num() > 0)
	{
		...
		T1ContentBrowserUtils::DisplayConfirmationPopup(
			...
			FOnClicked::CreateSP( this, &FT1AssetContextMenu::ExecuteDeleteFolderConfirmed ));
	}
}

bool FT1AssetContextMenu::CanExecuteReload() const
{
	TArray< FAssetData > AssetViewSelectedAssets = AssetView.Pin()->GetSelectedAssets();
	TArray< FString > SelectedFolders = AssetView.Pin()->GetSelectedFolders();

	int32 NumAssetItems, NumClassItems;
	T1ContentBrowserUtils::CountItemTypes(AssetViewSelectedAssets, NumAssetItems, NumClassItems);

	int32 NumAssetPaths, NumClassPaths;
	T1ContentBrowserUtils::CountPathTypes(SelectedFolders, NumAssetPaths, NumClassPaths);

	bool bHasSelectedCollections = false;
	for (const FString& SelectedFolder : SelectedFolders)
	{
		if (T1ContentBrowserUtils::IsCollectionPath(SelectedFolder))
		{
...
void FT1AssetContextMenu::ExecuteReload()
{
...
FReply FT1AssetContextMenu::ExecuteDeleteFolderConfirmed()
{
	TArray< FString > SelectedFolders = AssetView.Pin()->GetSelectedFolders();
	if(SelectedFolders.Num() > 0)
	{
...
void FT1AssetContextMenu::ExecuteConsolidate()
{
...
void FT1AssetContextMenu::ExecuteCaptureThumbnail()
{
	...
	if ( ensure(GCurrentLevelEditingViewportClient) && ensure(Viewport) )
	{
		...
		T1ContentBrowserUtils::CaptureThumbnailFromViewport(Viewport, SelectedAssets);
...
void FT1AssetContextMenu::ExecuteClearThumbnail()
{
	T1ContentBrowserUtils::ClearCustomThumbnails(SelectedAssets);
}

void FT1AssetContextMenu::ExecuteMigrateAsset()
{
...
void FT1AssetContextMenu::ExecuteGoToCodeForAsset(UClass* SelectedClass)
{
	if (SelectedClass)
	{
		FString ClassHeaderPath;
...
void FT1AssetContextMenu::ExecuteGoToDocsForAsset(UClass* SelectedClass)
{
	ExecuteGoToDocsForAsset(SelectedClass, FString());
}

void FT1AssetContextMenu::ExecuteGoToDocsForAsset(UClass* SelectedClass, const FString ExcerptSection)
{
	if (SelectedClass)
	{
...
void FT1AssetContextMenu::ExecuteCopyReference()
{
	T1ContentBrowserUtils::CopyAssetReferencesToClipboard(SelectedAssets);
}

void FT1AssetContextMenu::ExecuteCopyTextToClipboard(FString InText)
{
	FPlatformApplicationMisc::ClipboardCopy(*InText);
}

void FT1AssetContextMenu::ExecuteResetLocalizationId()
{
#if USE_STABLE_LOCALIZATION_KEYS
...
void FT1AssetContextMenu::ExecuteShowLocalizationCache(const FString InPackageFilename)
{
...
void FT1AssetContextMenu::ExecuteExport()
{
...
void FT1AssetContextMenu::ExecuteBulkExport()
{
	TArray<UObject*> ObjectsToExport;
	const bool SkipRedirectors = false;
	GetSelectedAssets(ObjectsToExport, SkipRedirectors);
...
void FT1AssetContextMenu::ExecuteRemoveFromCollection()
{
	if ( ensure(T1SourcesData.Collections.Num() == 1) )
	{
...
void FT1AssetContextMenu::ExecuteSCCRefresh()
{
...
void FT1AssetContextMenu::ExecuteSCCMerge()
{
	FAssetToolsModule& AssetToolsModule = FModuleManager::GetModuleChecked<FAssetToolsModule>("AssetTools");
...
void FT1AssetContextMenu::ExecuteSCCCheckOut()
{
...
void FT1AssetContextMenu::ExecuteSCCOpenForAdd()
{
	TArray<FString> PackageNames;
	GetSelectedPackageNames(PackageNames);
...
void FT1AssetContextMenu::ExecuteSCCCheckIn()
{
...
void FT1AssetContextMenu::ExecuteSCCHistory()
{
	TArray<FString> PackageNames;
	GetSelectedPackageNames(PackageNames);
...
void FT1AssetContextMenu::ExecuteSCCDiffAgainstDepot() const
{
	// Load the asset registry module
	FAssetToolsModule& AssetToolsModule = FModuleManager::GetModuleChecked<FAssetToolsModule>("AssetTools");
...
void FT1AssetContextMenu::ExecuteSCCRevert()
{
	TArray<FString> PackageNames;
	GetSelectedPackageNames(PackageNames);
...
void FT1AssetContextMenu::ExecuteSCCSync()
{
	TArray<FString> PackageNames;
	GetSelectedPackageNames(PackageNames);
	T1ContentBrowserUtils::SyncPackagesFromSourceControl(PackageNames);
}

void FT1AssetContextMenu::ExecuteEnableSourceControl()
{
	ISourceControlModule::Get().ShowLoginDialog(FSourceControlLoginClosed(), ELoginWindowMode::Modeless);
}

bool FT1AssetContextMenu::CanExecuteSyncToAssetTree() const
{
	return SelectedAssets.Num() > 0;
}

bool FT1AssetContextMenu::CanExecuteFindInExplorer() const
{
...
bool FT1AssetContextMenu::CanExecuteCreateBlueprintUsing() const
{
...
bool FT1AssetContextMenu::CanExecuteFindAssetInWorld() const
{
	return bAtLeastOneNonRedirectorSelected;
}

bool FT1AssetContextMenu::CanExecuteProperties() const
{
	return bAtLeastOneNonRedirectorSelected;
}

bool FT1AssetContextMenu::CanExecutePropertyMatrix(FText& OutErrorMessage) const
{
...
bool FT1AssetContextMenu::CanExecutePropertyMatrix() const
{
	FText ErrorMessageDummy;
	return CanExecutePropertyMatrix(ErrorMessageDummy);
}

FText FT1AssetContextMenu::GetExecutePropertyMatrixTooltip() const
{
	FText ResultTooltip;
...
bool FT1AssetContextMenu::CanExecuteShowAssetMetaData() const
{
	TArray<UObject*> ObjectsForPropertiesMenu;
	const bool SkipRedirectors = true;
	GetSelectedAssets(ObjectsForPropertiesMenu, SkipRedirectors);
...
bool FT1AssetContextMenu::CanExecuteDuplicate() const
{
...
bool FT1AssetContextMenu::CanExecuteRename() const
{
	return T1ContentBrowserUtils::CanRenameFromAssetView(AssetView);
}

bool FT1AssetContextMenu::CanExecuteDelete() const
{
	return T1ContentBrowserUtils::CanDeleteFromAssetView(AssetView);
}

bool FT1AssetContextMenu::CanExecuteRemoveFromCollection() const 
{
	return T1SourcesData.Collections.Num() == 1 && !T1SourcesData.IsDynamicCollection();
}

bool FT1AssetContextMenu::CanExecuteSCCRefresh() const
{
	return ISourceControlModule::Get().IsEnabled();
}

bool FT1AssetContextMenu::CanExecuteSCCMerge() const
{
	FAssetToolsModule& AssetToolsModule = FModuleManager::GetModuleChecked<FAssetToolsModule>("AssetTools");
...
bool FT1AssetContextMenu::CanExecuteSCCCheckOut() const
{
	return bCanExecuteSCCCheckOut;
}

bool FT1AssetContextMenu::CanExecuteSCCOpenForAdd() const
{
	return bCanExecuteSCCOpenForAdd;
}

bool FT1AssetContextMenu::CanExecuteSCCCheckIn() const
{
	return bCanExecuteSCCCheckIn;
}

bool FT1AssetContextMenu::CanExecuteSCCHistory() const
{
	return bCanExecuteSCCHistory;
}

bool FT1AssetContextMenu::CanExecuteSCCDiffAgainstDepot() const
{
	return bCanExecuteSCCHistory;
}

bool FT1AssetContextMenu::CanExecuteSCCRevert() const
{
	return bCanExecuteSCCRevert;
}

bool FT1AssetContextMenu::CanExecuteSCCSync() const
{
	return bCanExecuteSCCSync;
}

bool FT1AssetContextMenu::CanExecuteConsolidate() const
{
...
bool FT1AssetContextMenu::CanExecuteSaveAsset() const
{
...
bool FT1AssetContextMenu::CanExecuteDiffSelected() const
{
...
bool FT1AssetContextMenu::CanExecuteCaptureThumbnail() const
{
	return GCurrentLevelEditingViewportClient != NULL;
}

bool FT1AssetContextMenu::CanClearCustomThumbnails() const
{
	for ( auto AssetIt = SelectedAssets.CreateConstIterator(); AssetIt; ++AssetIt )
	{
		if ( T1ContentBrowserUtils::AssetHasCustomThumbnail(*AssetIt) )
		{
			return true;
		}
	}
...
void FT1AssetContextMenu::CacheCanExecuteVars()
{
	bAtLeastOneNonRedirectorSelected = false;
	bAtLeastOneClassSelected = false;
	bCanExecuteSCCMerge = false;
...
void FT1AssetContextMenu::GetSelectedPackageNames(TArray<FString>& OutPackageNames) const
{
	for (int32 AssetIdx = 0; AssetIdx < SelectedAssets.Num(); ++AssetIdx)
	{
...
void FT1AssetContextMenu::GetSelectedPackages(TArray<UPackage*>& OutPackages) const
{
	for (int32 AssetIdx = 0; AssetIdx < SelectedAssets.Num(); ++AssetIdx)
	{
...
void FT1AssetContextMenu::MakeChunkIDListMenu(FMenuBuilder& MenuBuilder)
{
	...
	for (auto ChunkID : FoundChunks)
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction(
				FExecuteAction::CreateSP(this, &FT1AssetContextMenu::ExecuteRemoveChunkID, ChunkID)
			)
		);
	}
}

void FT1AssetContextMenu::ExecuteAssignChunkID()
{
	TArray< FAssetData > AssetViewSelectedAssets = AssetView.Pin()->GetSelectedAssets();
		...
		Window->SetContent(
			...
			[
				...
				[
					...
					.MinValue(0)
					.MaxValue(300)
					.Value(this, &FT1AssetContextMenu::GetChunkIDSelection)
					.OnValueChanged(this, &FT1AssetContextMenu::OnChunkIDAssignChanged)
				]
			]
			+ SVerticalBox::Slot()
			.FillHeight(1.0f)
			...
			[
				...
				[
					...
					.OnClicked(this, &FT1AssetContextMenu::OnChunkIDAssignCommit, Window)
				]
				+ SHorizontalBox::Slot()
				.FillWidth(1.0f)
				.HAlign(HAlign_Left)
				...
				[
					...
					.OnClicked(this, &FT1AssetContextMenu::OnChunkIDAssignCancel, Window)
				]
			]
		);
...
void FT1AssetContextMenu::ExecuteRemoveAllChunkID()
{
...
TOptional<int32> FT1AssetContextMenu::GetChunkIDSelection() const
{
	return ChunkIDSelected;
}

void FT1AssetContextMenu::OnChunkIDAssignChanged(int32 NewChunkID)
{
	ChunkIDSelected = NewChunkID;
}

FReply FT1AssetContextMenu::OnChunkIDAssignCommit(TSharedPtr<SWindow> Window)
{
	TArray< FAssetData > AssetViewSelectedAssets = AssetView.Pin()->GetSelectedAssets();
	for (const auto& SelectedAsset : AssetViewSelectedAssets)
	{
...
FReply FT1AssetContextMenu::OnChunkIDAssignCancel(TSharedPtr<SWindow> Window)
{
	Window->RequestDestroyWindow();
...
void FT1AssetContextMenu::ExecuteRemoveChunkID(int32 ChunkID)
{
	TArray< FAssetData > AssetViewSelectedAssets = AssetView.Pin()->GetSelectedAssets();
	for (const auto& SelectedAsset : AssetViewSelectedAssets)
	{
