...
class FT1AssetContextMenu : public TSharedFromThis<FT1AssetContextMenu>
{
public:
	/** Constructor */
	FT1AssetContextMenu(const TWeakPtr<ST1AssetView>& InAssetView);
	...
	TSharedRef<SWidget> MakeContextMenu(const TArray<FAssetData>& SelectedAssets, const FT1SourcesData& InSourcesData, TSharedPtr< FUICommandList > InCommandList);
	...
	void SetOnFindInAssetTreeRequested(const FT1OnFindInAssetTreeRequested& InOnFindInAssetTreeRequested);
...
private:
	...
	TWeakPtr<ST1AssetView> AssetView;
