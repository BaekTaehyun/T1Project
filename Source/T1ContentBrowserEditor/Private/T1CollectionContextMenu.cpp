...
FT1CollectionContextMenu::FT1CollectionContextMenu(const TWeakPtr<SCollectionView>& InCollectionView)
	: CollectionView(InCollectionView)
	, bProjectUnderSourceControl(false)
{
}

void FT1CollectionContextMenu::BindCommands(TSharedPtr< FUICommandList > InCommandList)
{
	InCommandList->MapAction( FGenericCommands::Get().Rename, FUIAction(
		FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteRenameCollection ),
		FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteRenameCollection )
		));
}

TSharedPtr<SWidget> FT1CollectionContextMenu::MakeCollectionTreeContextMenu(TSharedPtr< FUICommandList > InCommandList)
{
	...
	TArray<FT1ContentBrowserMenuExtender> MenuExtenderDelegates = ContentBrowserModule.GetAllCollectionListContextMenuExtenders();
	...
	TArray<TSharedPtr<FT1CollectionItem>> SelectedCollections = CollectionView.Pin()->CollectionTreePtr->GetSelectedItems();
	...
	for (int32 CollectionIdx = 0; CollectionIdx < SelectedCollections.Num(); ++CollectionIdx)
	{
		...
		bAnyNeedSCCUpdate |= SelectedCollections[CollectionIdx]->CurrentStatus == ET1CollectionItemStatus::IsOutOfDate;
		bAnyNeedSave |= SelectedCollections[CollectionIdx]->CurrentStatus == ET1CollectionItemStatus::HasLocalChanges;
	...
	MenuBuilder.BeginSection("CollectionOptions", LOCTEXT("CollectionListOptionsMenuHeading", "Collection Options"));
	{
...

		{
			...
			MenuBuilder.AddSubMenu(
				...
				FNewMenuDelegate::CreateRaw( this, &FT1CollectionContextMenu::MakeNewCollectionSubMenu, ECollectionStorageMode::Static, SCollectionView::FCreateCollectionPayload( ParentCollection ) ),
				FUIAction(
					FExecuteAction(),
		...
		MenuBuilder.AddSubMenu(
			...
			FNewMenuDelegate::CreateRaw( this, &FT1CollectionContextMenu::MakeCollectionShareTypeSubMenu ),
			FUIAction(
				FExecuteAction(),
		...
		if ( CollectionViewUtils::HasCustomColors() )
		{
			...
			MenuBuilder.AddSubMenu(
				...
				FNewMenuDelegate::CreateRaw( this, &FT1CollectionContextMenu::MakeSetColorSubMenu )
				);
		}
		else
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				LOCTEXT("SetCollectionColorTooltip", "Sets the color this collection should appear as."),
				FSlateIcon(),
				FUIAction( FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecutePickColor ) )
				);
		}
	}
	...
	if ( SelectedCollections.Num() > 0 )
	{
		MenuBuilder.BeginSection("CollectionBulkOperations", LOCTEXT("CollectionListBulkOperationsMenuHeading", "Bulk Operations"));
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
					FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteSaveCollection ),
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
					FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteDestroyCollection ),
					FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteDestroyCollection, bAnyManagedBySCC )
					)
				);
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
					FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteUpdateCollection ),
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(
					FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteRefreshCollection ),
...
void FT1CollectionContextMenu::MakeNewCollectionSubMenu(FMenuBuilder& MenuBuilder, ECollectionStorageMode::Type StorageMode, SCollectionView::FCreateCollectionPayload InCreationPayload)
{
	...
	MenuBuilder.BeginSection("CollectionNewCollection", MenuHeading);
	{
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteNewCollection, ECollectionShareType::CST_Shared, StorageMode, InCreationPayload ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteNewCollection, ECollectionShareType::CST_Shared, bCanCreateSharedChildren )
				)
			);
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteNewCollection, ECollectionShareType::CST_Private, StorageMode, InCreationPayload ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteNewCollection, ECollectionShareType::CST_Private, bCanCreatePrivateChildren )
				)
			);
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteNewCollection, ECollectionShareType::CST_Local, StorageMode, InCreationPayload ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteNewCollection, ECollectionShareType::CST_Local, bCanCreateLocalChildren )
				)
			);
	}
	MenuBuilder.EndSection();
...
void FT1CollectionContextMenu::MakeSaveDynamicCollectionSubMenu(FMenuBuilder& MenuBuilder, FText InSearchQuery)
{
	auto OnCollectionCreated = FT1CollectionItem::FCollectionCreatedEvent::CreateSP(this, &FT1CollectionContextMenu::ExecuteSaveDynamicCollection, InSearchQuery);
	...
	if (AvailableCollections.Num() > 0)
	{
		...
		for (const FCollectionNameType& AvailableCollection : AvailableCollections)
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				FUIAction(
					FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteSaveDynamicCollection, AvailableCollection, InSearchQuery ),
					FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteSaveDynamicCollection, AvailableCollection )
					)
				);
		}
...
void FT1CollectionContextMenu::MakeCollectionShareTypeSubMenu(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.BeginSection("CollectionShareType", LOCTEXT("CollectionShareTypeMenuHeading", "Collection Share Type"));
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon( FEditorStyle::GetStyleSetName(), ECollectionShareType::GetIconStyleName( ECollectionShareType::CST_Shared ) ),
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteSetCollectionShareType, ECollectionShareType::CST_Shared ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteSetCollectionShareType, ECollectionShareType::CST_Shared ),
				FIsActionChecked::CreateSP( this, &FT1CollectionContextMenu::IsSetCollectionShareTypeChecked, ECollectionShareType::CST_Shared )
				),
			NAME_None,
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon( FEditorStyle::GetStyleSetName(), ECollectionShareType::GetIconStyleName( ECollectionShareType::CST_Private ) ),
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteSetCollectionShareType, ECollectionShareType::CST_Private ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteSetCollectionShareType, ECollectionShareType::CST_Private ),
				FIsActionChecked::CreateSP( this, &FT1CollectionContextMenu::IsSetCollectionShareTypeChecked, ECollectionShareType::CST_Private )
				),
			NAME_None,
			EUserInterfaceActionType::Check
			);
		...
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon( FEditorStyle::GetStyleSetName(), ECollectionShareType::GetIconStyleName( ECollectionShareType::CST_Local ) ),
			FUIAction(
				FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteSetCollectionShareType, ECollectionShareType::CST_Local ),
				FCanExecuteAction::CreateSP( this, &FT1CollectionContextMenu::CanExecuteSetCollectionShareType, ECollectionShareType::CST_Local ),
				FIsActionChecked::CreateSP( this, &FT1CollectionContextMenu::IsSetCollectionShareTypeChecked, ECollectionShareType::CST_Local )
				),
			NAME_None,
			EUserInterfaceActionType::Check
			);
...
void FT1CollectionContextMenu::MakeSetColorSubMenu(FMenuBuilder& MenuBuilder)
{
	// New Color
	MenuBuilder.AddMenuEntry(
	...
	if ( SelectedHasCustomColors() )
	{
		MenuBuilder.AddMenuEntry(
			...
			FSlateIcon(),
			FUIAction( FExecuteAction::CreateSP( this, &FT1CollectionContextMenu::ExecuteResetColor ) )
			);
	}
			...
			for ( int32 ColorIndex = 0; ColorIndex < CustomColors.Num(); ColorIndex++ )
			{
				...
				MenuBuilder.AddWidget(
						...
						[
							...
							.OnClicked( this, &FT1CollectionContextMenu::OnColorClicked, Color )
							[
								SNew(SColorBlock)
								.Color( Color )
...
void FT1CollectionContextMenu::UpdateProjectSourceControl()
{
...
bool FT1CollectionContextMenu::CanRenameSelectedCollections() const
{
	TArray<TSharedPtr<FT1CollectionItem>> SelectedCollections = CollectionView.Pin()->CollectionTreePtr->GetSelectedItems();
...
void FT1CollectionContextMenu::ExecuteNewCollection(ECollectionShareType::Type CollectionType, ECollectionStorageMode::Type StorageMode, SCollectionView::FCreateCollectionPayload InCreationPayload)
{
...
void FT1CollectionContextMenu::ExecuteSetCollectionShareType(ECollectionShareType::Type CollectionType)
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
...
void FT1CollectionContextMenu::ExecuteSaveDynamicCollection(FCollectionNameType InCollection, FText InSearchQuery)
{
	FCollectionManagerModule& CollectionManagerModule = FCollectionManagerModule::GetModule();
...
void FT1CollectionContextMenu::ExecuteRenameCollection()
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
...
void FT1CollectionContextMenu::ExecuteUpdateCollection()
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
...
void FT1CollectionContextMenu::ExecuteRefreshCollection()
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
...
void FT1CollectionContextMenu::ExecuteSaveCollection()
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
...
void FT1CollectionContextMenu::ExecuteDestroyCollection()
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return;
	...
	FOnClicked OnYesClicked = FOnClicked::CreateSP( this, &FT1CollectionContextMenu::ExecuteDestroyCollectionConfirmed, SelectedCollections );
...
FReply FT1CollectionContextMenu::ExecuteDestroyCollectionConfirmed(TArray<TSharedPtr<FT1CollectionItem>> CollectionList)
{
	CollectionView.Pin()->DeleteCollectionItems(CollectionList);
	return FReply::Handled();
}

void FT1CollectionContextMenu::ExecuteResetColor()
{
	ResetColors();
}

void FT1CollectionContextMenu::ExecutePickColor()
{
	...
	PickerArgs.OnColorPickerWindowClosed = FOnWindowClosed::CreateSP(this, &FT1CollectionContextMenu::NewColorComplete);

	OpenColorPicker(PickerArgs);
}

bool FT1CollectionContextMenu::CanExecuteNewCollection(ECollectionShareType::Type CollectionType, bool bIsValidChildType) const
{
...
bool FT1CollectionContextMenu::CanExecuteSetCollectionShareType(ECollectionShareType::Type CollectionType) const
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return false;
...
bool FT1CollectionContextMenu::IsSetCollectionShareTypeChecked(ECollectionShareType::Type CollectionType) const
{
	if ( !ensure(CollectionView.IsValid()) )
	{
		return false;
...
bool FT1CollectionContextMenu::CanExecuteSaveDynamicCollection(FCollectionNameType InCollection) const
{
...
bool FT1CollectionContextMenu::CanExecuteRenameCollection() const
{
	return CanRenameSelectedCollections();
}

bool FT1CollectionContextMenu::CanExecuteDestroyCollection(bool bAnyManagedBySCC) const
{
...
bool FT1CollectionContextMenu::SelectedHasCustomColors() const
{
	TSharedPtr<SCollectionView> CollectionViewPtr = CollectionView.Pin();
	TArray<FCollectionNameType> SelectedCollections = CollectionViewPtr->GetSelectedCollections();
...
void FT1CollectionContextMenu::NewColorComplete(const TSharedRef<SWindow>& Window)
{
	TSharedPtr<SCollectionView> CollectionViewPtr = CollectionView.Pin();
	TArray<FCollectionNameType> SelectedCollections = CollectionViewPtr->GetSelectedCollections();
...
FReply FT1CollectionContextMenu::OnColorClicked( const FLinearColor InColor )
{
	TSharedPtr<SCollectionView> CollectionViewPtr = CollectionView.Pin();
	TArray<FCollectionNameType> SelectedCollections = CollectionViewPtr->GetSelectedCollections();
...
void FT1CollectionContextMenu::ResetColors()
{
	TSharedPtr<SCollectionView> CollectionViewPtr = CollectionView.Pin();
	TArray<FCollectionNameType> SelectedCollections = CollectionViewPtr->GetSelectedCollections();
